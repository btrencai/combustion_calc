...
def calculate_combustion(power_watts, phi, h2_vol_fraction):
    ...
    # ================= 4. 混合后总组分 =================
    # 这里的 mass_CH4 和 mass_H2 本质就是 kg/s 的分量
    ...
    slpm_air = (m_dot_air * 1000 / M_AIR) * Vm_STP * 60
    ...
    print(f"👉 [实验流量计 - SLPM (0℃, 1atm)]")
    print(f"   Air 流量: {slpm_air:.2f} SLPM")
    print(f"   CH4 流量: {slpm_ch4:.2f} SLPM")
    if h2_vol_fraction > 0:
        print(f"   H2  流量: {slpm_h2:.2f} SLPM")
    print("=" * 60 + "\n")


# ================= 主程序 (交互逻辑) =================
if __name__ == "__main__":
    print("\ncombustion_calc by zzm")
    print("-------------------------------------------")
